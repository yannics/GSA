...
\usepackage{tikz}
\newcommand*\circled[1]{\tikz[baseline=(char.base), line width=1pt]{
            \node[shape=circle,draw,inner sep=1pt] (char) {\textbf{#1}};}}
\newcommand*\squared[1]{\tikz[baseline=(char.base), line width=1pt]{
            \node[shape=rectangle,draw,inner sep=2pt] (char) {\textbf{#1}};}}
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\Large \textsf{2014 -- 2024}} % Subtitle
...
%See \texttt{gsa.quark} SuperCollider extension at \href{https://github.com/yannics/GSA}{\texttt{\small https://github.com/yannics/GSA}}
...
\begin{mdframed}[style=stylesec]
\section{\textit{untitled} \texttt{\#1}}
\label{scp}
\smallskip
\end{mdframed}
...
%
%\include{mp/sh}
\markboth{... about music vestiges -- Open Composition}{Generative Sonic Art}
\thispagestyle{empty}

\include{mp/oc}

\markboth{... about music vestiges -- Studies}{Generative Sonic Art}
\thispagestyle{empty}
...
\markboth{Appendices}{Generative Sonic Art}
\thispagestyle{empty}
...
%\chapter*{}
\addcontentsline{toc}{chapter}{Distance}
...
Basically, this is defined as follows:
...
%\begin{mdframed}[style=stylesec]
%\chapter*{}
\addcontentsline{toc}{chapter}{* Outline of the Standard MIDI File Structure}
...
%\begin{mdframed}[style=stylesec]
%\chapter*{}
\addcontentsline{toc}{chapter}{* The Newick tree format}
\chapter*{The Newick tree format}
\label{nwdoc}
%\label{tript}
%\smallskip
%\end{mdframed}
...
%\begin{mdframed}[style=stylesec]
\chapter*{}
\addcontentsline{toc}{chapter}{* Psychoacoustics -- Roughness}
