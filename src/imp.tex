...
\section{\textsl{Proportional canon as an event climax}}
 \addtocontents{toc}{\smallskip \hspace{\parindent} [ \ref{tript} -- \ref{d01} -- \ref{scp} ]  \par}
...
\section{\textsl{Fractal}}
 \addtocontents{toc}{\smallskip \hspace{\parindent} [ \ref{hex0} -- \ref{d01} -- \ref{105A1408} ]  \par}
