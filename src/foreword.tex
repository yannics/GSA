...
\smallskip
For instance, one of the connected works is the \textsl{Neuromuse3} project (N3) which aims to develop algorithms in terms of neuroscience and cognition in a `musical' context. The documentation is available on the:
