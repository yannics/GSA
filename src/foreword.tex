...
\bigskip
The Common Lisp library M2T mentioned in the chapters \textsl{\nameref{m2t}} and  \textsl{\nameref{mds}} is available on:

\href{https://github.com/yannics/M2T}{\texttt{\small https://github.com/yannics/M2T}}

\bigskip
The Common Lisp library \textsl{cl-cycle} mentioned in the chapters \textsl{\nameref{imp1}} and  \textsl{\nameref{imp2}} is available on:
