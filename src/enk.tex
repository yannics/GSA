...
Sometimes, the discriminative algorithm is not accurate or efficient enough. In this case, the segmentation can be edited in Praat. In order to format the TextGrid as an ordered integer as label, it is recommanded to apply the script \nameref{ftg} -- see appendix \fullref{ftg}.
