...
\bfseries :diff & \bfseries :opt :min & \bfseries :opt :max & \bfseries :opt :mean \csvreader[head to column names]{src/dtb-diff.csv}{}
 {\\\diff & \min & \max & \mean}%
 \\\hline 
 \end{tabular}}
...
\centering
 {\ttfamily 
 \begin{tabular}{|c|r|r|r|}\hline%
\bfseries :sim & \bfseries :opt :min & \bfseries :opt :max & \bfseries :opt :mean \csvreader[head to column names]{src/dtb-sim.csv}{}
 {\\\sim & \min & \max & \mean}%
 \\\hline 
 \end{tabular}}
