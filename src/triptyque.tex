...
%\noindent \textbf{{\large Prise de son MS}}
%\hrulefill

% \begin{figure}[H]
%\begin{center}
%\includegraphics[scale=0.23]{img/H2N.png}
%\caption{Zoom H2N en mode 4 canaux génére deux fichiers sons stéreo impliquant les micros MS et XY (figure page 21 du mode d'emploi).}
%\label{h2n}
%\end{center}
%\end{figure}
