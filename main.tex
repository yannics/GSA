...
The notion of remoteness is also defined
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.7]{img/1122}
\caption{Graph showing direct versus reverberant sound for distance from source in reverberant rooms. %The sound level decreases of 6 dB for each doubling of the distance such as $-20\,log_{10}\: distance$.
}
